...
model = keras.Sequential([keras.layers.Dense(units=1, input_shape=[7])])
...
print('Desired output: 24 = 2 x 9 + 6')
print(model.predict(np.array([[47.0, 9.0, 28.0, 0.0, 7.0, 6.0, 10.0]])))